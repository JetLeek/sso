...
public class JsonUtil {
    ...
    public static String json2String(Object o) {
        ...
        try {
            ...
            LOG.error("Error when converting a json object to a string. " + e.getMessage(), e);
            return "";
        }
    }
    ...
    public static JsonNode string2Json(String s) {
        try {
            ...
            LOG.error("Error when converting a string to a json object. " + e.getMessage(), e);
            return null;
        }
    }
    ...
    public static <T> T string2Object(String s, Class<T> clazz) {
        try {
            ...
            LOG.error("Error when converting a string to a object. " + e.getMessage(), e);
            return null;
        }
    }
}
